...
log_file = os.path.join(log_dir, 'bmcvetres_download.log')
...
def main():
    ...
    pmcid_file = '/Users/ksinfosys/Downloads/pmcid-BMCVetRe.txt'

    # Output directory for XML files
    output_dir = '/Users/ksinfosys/medical/data-pipeline/guidelines/xml_bmcvetres'
