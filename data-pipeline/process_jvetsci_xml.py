...
# 진행 상황 파일
PROGRESS_FILE = Path("/Users/ksinfosys/medical/data-pipeline/jvetsci_processing_progress.json")
...
if __name__ == "__main__":
    xml_folder = Path("/Users/ksinfosys/medical/data-pipeline/guidelines/xml_jvetsci")
